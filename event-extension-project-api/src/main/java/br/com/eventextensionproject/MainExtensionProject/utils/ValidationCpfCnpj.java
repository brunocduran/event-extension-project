package br.com.eventextensionproject.MainExtensionProject.utils;
...
public class ValidationCpfCnpj {
    ...
    public static boolean isValidCpfCnpj(String documento) {
        if (documento != null) {
            String apenasNumeros = limpar(documento);
            if (apenasNumeros.length() == 14) {
                return isCNPJ(apenasNumeros);
            }
            if (apenasNumeros.length() == 11) {
                return isCPF(apenasNumeros);
            }
        }
        return false;
    }
